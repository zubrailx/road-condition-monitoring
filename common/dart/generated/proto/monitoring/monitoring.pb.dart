...
class UserAccount extends $pb.GeneratedMessage {
  ...
  UserAccount._() : super();
  factory UserAccount.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserAccount.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
...
class AccelerometerRecord extends $pb.GeneratedMessage {
  ...
  factory AccelerometerRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AccelerometerRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AccelerometerRecord',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'monitoring'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AccelerometerRecord copyWith(void Function(AccelerometerRecord) updates) =>
      super.copyWith((message) => updates(message as AccelerometerRecord))
          as AccelerometerRecord;
  ...
  static $pb.PbList<AccelerometerRecord> createRepeated() =>
      $pb.PbList<AccelerometerRecord>();
  @$core.pragma('dart2js:noInline')
  static AccelerometerRecord getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AccelerometerRecord>(create);
...
class GyroscopeRecord extends $pb.GeneratedMessage {
  ...
  factory GyroscopeRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GyroscopeRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GyroscopeRecord',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'monitoring'),
      createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, _omitFieldNames ? '' : 'time',
        subBuilder: $0.Timestamp.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GyroscopeRecord copyWith(void Function(GyroscopeRecord) updates) =>
      super.copyWith((message) => updates(message as GyroscopeRecord))
          as GyroscopeRecord;
  ...
  static $pb.PbList<GyroscopeRecord> createRepeated() =>
      $pb.PbList<GyroscopeRecord>();
  @$core.pragma('dart2js:noInline')
  static GyroscopeRecord getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GyroscopeRecord>(create);
...
class GpsRecord extends $pb.GeneratedMessage {
  ...
  GpsRecord._() : super();
  factory GpsRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GpsRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GpsRecord',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'monitoring'),
      createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, _omitFieldNames ? '' : 'time',
        subBuilder: $0.Timestamp.create)
    ...
    ..a<$core.double>(
        12, _omitFieldNames ? '' : 'longitude', $pb.PbFieldType.OD)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GpsRecord copyWith(void Function(GpsRecord) updates) =>
      super.copyWith((message) => updates(message as GpsRecord)) as GpsRecord;
  ...
  @$core.pragma('dart2js:noInline')
  static GpsRecord getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GpsRecord>(create);
...
class Monitoring extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'monitoring'),
      createEmptyInstance: create)
    ..pc<AccelerometerRecord>(
        1, _omitFieldNames ? '' : 'accelerometerRecords', $pb.PbFieldType.PM,
        subBuilder: AccelerometerRecord.create)
    ..pc<GyroscopeRecord>(
        2, _omitFieldNames ? '' : 'gyroscopeRecords', $pb.PbFieldType.PM,
        subBuilder: GyroscopeRecord.create)
    ..pc<GpsRecord>(3, _omitFieldNames ? '' : 'gpsRecords', $pb.PbFieldType.PM,
        subBuilder: GpsRecord.create)
    ..aOM<UserAccount>(11, _omitFieldNames ? '' : 'account',
        subBuilder: UserAccount.create)
    ..hasRequiredFields = false;
